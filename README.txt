...
Создан полноценный интернет-магазин со следующими страницами:
...
• Регистрация юрлица
• Войти
• ЛК Физлицо текущие заказы
• ЛК Юрлицо Текущие заказы
• Оформление заказа физлицо
• Оформление заказа физлицо (продолжение)
• Оформление заказа физлицо, другой город
• Оформление заказа юрлицо (когда зарегистрирован)
• Оформление заказа Когда есть профиль
• Оформление заказа Когда есть профиль - Добавить новый
• Заказ сформирован
• Физлицо заказ подробно
• Форма Написать нам
• Страница 404
• Контакты
...
• Похожие товары
• Заказать товар
• Редактировать профиль. Физлицо
• Редактировать профиль. Юрлицо
• Новый список
